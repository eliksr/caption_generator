...
cg = gen.CaptionGenerator('../Xray_text/side_top_3')
...
class Eval():
    ...
    def generate_captions(self, model, image, beam_size):
    ...
    def test_model(self, main_dir, model, img_name, beam_size=3):
        ...
        captions = self.generate_captions(model, image, beam_size)
...
#     model.load_weights(weight)
#
#     f_pred_caption = open('predicted_captions.txt', 'w')
#
...
#
#     f_captions = open('../Xray_text/xray_testImages.txt', 'r')
...
if __name__ == '__main__':
    weight = '/Users/esror/PycharmProjects/caption_app/Xray_text/front_top_3/WholeModel_1.h5'
    test_image = '1013_IM-0013-1001.dcm'
    test_img_dir = '../Xray_text/xray_testImages.txt'
    eval_model = Eval()
    print(eval_model.test_model('../Xray_text/front_top_3', weight, test_image))
